(function() {
  ...
  SWITCHES = [['-e', '--execute [CMD]', 'cmd to execute upon file change. use {}, {source}, {basename}, {basename_noext}, {dirname} for path placeholder(s).'], ['-p', '--path', 'path to dir, or file to watch.'], ['-r', '--pattern [PATTERN]', 'pattern for filenames to match if watching a dir.'], ['-h', '--help', 'display this help message'], ['-v', '--version', 'display the version number']];
  ...
  exports.run = function() {
    ...
    k = new kckr.Kckr(sources, function(source) {
    ...
    return timeLog("kckr is watching (O_O )");
  };
